...
// Fetch only 'pending' orders for today
...
<head>
    ...
    <style>
        ...
        .order-card { background: #333; border-top: 8px solid #007bff; padding: 15px; border-radius: 8px; position: relative; }
        .order-header { color: #00ff00; font-size: 1.4rem; font-weight: bold; margin-bottom: 10px; border-bottom: 1px solid #444; }
        ...
        .notes { color: #ffcc00; font-style: italic; background: #444; padding: 5px; border-radius: 4px; margin-top: 10px; }
    </style>
</head>
<body>
    ...
    <div class="grid">
        ...
        ?>
            <div class="order-card">
                ...
                <div style="font-size: 1.1rem;"><?php echo nl2br(htmlspecialchars($row['items'])); ?></div>
                
                <?php if(!empty($row['notes'])): ?>
                    <div class="notes">Note: <?php echo htmlspecialchars($row['notes']); ?></div>
                <?php endif; ?>
